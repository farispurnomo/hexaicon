...
export default class Framework extends Plugin<FrameworkOptions> {
            ...
            this.core.registerPlugin(
                ...
                new Message({
                    ...
                    container: (field, element) => {
                        ...
                        return Message.getClosestContainer(
                            element,
                            groupEle,
    ...
    protected onIconPlaced(_e: IconPlacedEvent): void {} // eslint-disable-line @typescript-eslint/no-empty-function
    protected onMessagePlaced(_e: MessagePlacedEvent): void {} // eslint-disable-line @typescript-eslint/no-empty-function
    ...
    private prepareFieldContainer(
        ...
        if (elements.length) {
            ...
            if ('radio' === type || 'checkbox' === type) {
                ...
                elements.forEach((ele) =>
                    this.prepareElementContainer(field, ele)
                );
            }
        }
    }
    ...
    private removeClasses(element: HTMLElement, elements: HTMLElement[]): void {
        ...
        const ele =
            'radio' === type || 'checkbox' === type ? elements[0] : element;
