        ...
        <div class="card-header border-0 pt-6">
            <div class="card-title">
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <input type="text" data-kt-customer-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search Icon Categories" />
                </div>
            </div>
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            return `<img loading="lazy" width="64" class="img-fluid rounded-circle img-thumbnail" draggable="false" src="${row.url_image}"/>`;
                        }
                    },
                    {
                        data: 'id',
                        ...
                        render: function(data, type, row) {
                            return `
								...
								<a href="<?= base_url($route . '/delete/') ?>${row.id}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm btn-delete">
                                    <span class="svg-icon svg-icon-3">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
