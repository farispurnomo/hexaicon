            ...
            <div class="card card-flush py-4">
                ...
                <div class="card-body pt-0">
                    <div class="mb-10 fv-row">
                        ...
                        <input type="text" name="name" class="form-control mb-2" required value="<?= set_value('email') ?>" />
                        <?= form_error('name', '<div class="text-danger">', '</div>') ?>
                    </div>
                    <div class="mb-10 fv-row">
                        <label class="required form-label">Description</label>
                        <input type="text" name="description" class="form-control mb-2" required value="<?= set_value('description') ?>" />
                        <?= form_error('description', '<div class="text-danger">', '</div>') ?>
                    </div>
                    <div class="mb-10 fv-row">
                        <label class="required form-label">Price</label>
                        <input type="text" name="price" class="form-control mb-2 autonumeric" required value="<?= set_value('price') ?>" />
                        <?= form_error('price', '<div class="text-danger">', '</div>') ?>
                    </div>
                    <div class="mb-10 fv-row">
                        <label class="form-label">Item</label>
                        <div id="draggable-zone">
                            <div class="row mb-3 draggable" data-id="1">
                                <div class="col-1">
