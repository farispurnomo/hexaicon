        ...
        <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
            ...
            <div class="card card-flush py-4">
                ...
                <div class="card-body pt-0">
                    <select name="subscription_plan_id" class="form-select mb-2" data-control="select2" data-hide-search="true" data-placeholder="Select an option" required>
            ...
            <div class="card card-flush py-4">
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="mb-10 fv-row">
                        ...
                        <input type="email" name="email" class="form-control form-control-solid mb-2" required value="<?= set_value('email') ?>" />
                        <?= form_error('email', '<div class="text-danger">', '</div>') ?>
                    </div>
                    <div class="mb-10 fv-row">
                        <label class="required form-label">Password</label>
                        <input type="password" name="password" class="form-control form-control-solid mb-2" required minlength="6" />
                        <?= form_error('password', '<div class="text-danger">', '</div>') ?>
                    </div>
                    <div class="mb-10 fv-row">
                        <label class="form-label">Name</label>
                        <input type="text" name="name" class="form-control form-control-solid mb-2" value="<?= set_value('name') ?>" />
                    </div>
                    <div class="mb-10 fv-row">
                        <label class="form-label">Job</label>
                        <input type="text" name="position" class="form-control form-control-solid mb-2" value="<?= set_value('job') ?>" />
                    </div>
                </div>
            </div>
