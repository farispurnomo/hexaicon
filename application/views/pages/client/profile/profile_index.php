                    ...
                    <div class="py-2 py-md-5">
                        ...
                        <div class="px-5 mb-3">
                            <div class="profilepic rounded-circle m-auto" role="button">
                                <img id="image" class="profilepic__image w-100 h-100" src="<?= $user->url_image ?>" />
                        ...
                        <div class="mb-3">
                            ...
                            <div class="badge rounded-pill bg-hi-primary px-4 py-2"><?= $user->subscription_name ?></div>
                        </div>

                        <div class="mb-3">
                            <div class="fw-bold">Subscription expired in</div>
                            <div><?= $user->subscription_ends_at ?: '-' ?></div>
                        </div>
                ...
                <div class="col-md-9 d-flex align-self-center">
                    <div class="w-100 p-2 pt-5 p-md-5">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="job" name="position" class="form-control" value="<?= $user->position ?>">
                        </div>

                        <div class="mb-3">
                            <label class="form-label" for="email">Email</label>
                            <input type="text" id="email" class="form-control-plaintext" value="<?= $user->email ?>">
                        </div>
