...
{
    private $namespace    = 'pages/admin/icons/style/style_';
    private $route        = 'admin/icons/style';
    private $pagetitle    = 'Icon Style';
    private $extend_view  = 'layouts/admin';
    private $table_id     = 'kt_icon_styles_table';
    private $permission   = 'icon_style:';
    ...
    public function __construct()
    {
        ...
        $this->load->model('M_admin_icon_style');
    }
    ...
    public function index()
    {
        ...
        $data['subheaders']             = ['Icon Style' => base_url($this->route . '.index')];
    ...
    public function paginate()
    {
        ...
        try {
            ...
            $items                      = $this->M_admin_icon_style->doGetIconStyleData($search, $sort_field, $sort_dir, $offset, $limit);

            $datarow['draw']            = (int) $draw;
            $datarow['recordsTotal']    = $this->M_admin_icon_style->doCountIconStyleData();
            $datarow['recordsFiltered'] = $this->M_admin_icon_style->doCountIconStyleData($search);
            $datarow['data']            = $items;
        } catch (Throwable $th) {
    ...
    public function store()
    {
        ...
        try {
            ...
            $this->M_admin_icon_style->doInsertIconStyleData($icon_style);
    ...
    public function edit($id = null)
    {
        ...
        $data['record']                 = $this->M_admin_icon_style->doGetFirstIconStyleData($id);
    ...
    public function update($id = null)
    {
        ...
        try {
            ...
            $record            = $this->M_admin_icon_style->doGetFirstIconStyleData($id);
            ...
            $this->M_admin_icon_style->doUpdateIconStyleData($id, $icon_style);
    ...
    public function delete($id = null)
    {
        ...
        $this->M_admin_icon_style->doDeleteIconStyleData($id);
